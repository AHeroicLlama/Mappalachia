...
unit _commonwealthCartography_positionData;
	...
	begin
		...
		ripWorldspaces();
		AddMessage('Finished Commonwealth Cartography exterior position data export.');
		AddMessage('Beginning Commonwealth Cartography interior position data export...');
		ripInteriors();
