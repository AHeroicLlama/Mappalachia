...
SELECT A.spaceFormID, spaceEditorID, spaceDisplayName, isWorldspace, xCenter, YCenter, xMin, xMax, yMin, yMax, nudgeX, nudgeY, nudgeScale, esmNumber FROM Space_Info as A
INNER JOIN
