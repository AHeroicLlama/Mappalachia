...
CREATE TABLE Position_Data(spaceFormID TEXT, referenceFormID TEXT, x INTEGER, y INTEGER, z INTEGER, locationFormID TEXT, lockLevel TEXT, primitiveShape TEXT, boundX INTEGER, boundY INTEGER, boundZ INTEGER, rotZ INTEGER, mapMarkerName TEXT, label TEXT, spawnClass TEXT);
