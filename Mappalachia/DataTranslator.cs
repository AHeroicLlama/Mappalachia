		...
		public static string GetDescription(this Signature signature)
		{
			return signature switch
			{
				...
				Signature.FURN => "Object or position which a character can use to enter into an animation.\n" +
					"Includes workbenches and instruments, but also enemy ambush positions such as scorchbeast spawns.",
				...
				Signature.LVLI => "Lootable object which has some odds of spawning.",
