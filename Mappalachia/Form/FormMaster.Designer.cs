namespace Mappalachia
{
	partial class FormMaster
	{
		...
		private void InitializeComponent()
		{
			...
			this.noneBackgroundMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.grayScaleMapIconsMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.showMapLabelsMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.legendStyleMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.compactLegendMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.extendedLegendMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.hiddenLegendMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.viaDiscordMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.joinDiscordMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			// 
			this.noneBackgroundMenuItem.Name = "noneBackgroundMenuItem";
			this.noneBackgroundMenuItem.Size = new System.Drawing.Size(115, 22);
			this.noneBackgroundMenuItem.Text = "None";
			this.noneBackgroundMenuItem.ToolTipText = "No background (transparent).";
			this.noneBackgroundMenuItem.Click += new System.EventHandler(this.Map_Image_None);
			// 
            ...
            this.grayScaleMapIconsMenuItem,
			...
			// 
			this.grayScaleMapIconsMenuItem.Name = "grayScaleMapIconsMenuItem";
			this.grayScaleMapIconsMenuItem.Size = new System.Drawing.Size(180, 22);
			this.grayScaleMapIconsMenuItem.Text = "Grayscale Icons";
			this.grayScaleMapIconsMenuItem.ToolTipText = "Toggle grayscale map icons.";
			this.grayScaleMapIconsMenuItem.Click += new System.EventHandler(this.Map_MapMarkers_GrayscaleIcons);
			// 
			...
			// legendStyleMenuItem
			// 
			this.legendStyleMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.compactLegendMenuItem,
            this.extendedLegendMenuItem,
            this.hiddenLegendMenuItem});
			this.legendStyleMenuItem.Name = "legendStyleMenuItem";
			this.legendStyleMenuItem.Size = new System.Drawing.Size(216, 22);
			this.legendStyleMenuItem.Text = "Legend Style";
			this.legendStyleMenuItem.ToolTipText = "Change where or if the legend is drawn.";
			// 
			...
			this.quickSaveMenuItem.ShortcutKeys = ((System.Windows.Forms.Keys)(((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.Shift) 
            | System.Windows.Forms.Keys.S)));
			this.quickSaveMenuItem.Size = new System.Drawing.Size(216, 22);
			this.quickSaveMenuItem.Text = "Quick Save";
			this.quickSaveMenuItem.ToolTipText = "Quickly saves the current map to a file and displays it in the file explorer.";
			this.quickSaveMenuItem.Click += new System.EventHandler(this.Map_QuickSave);
			// 
			// clearMenuItem
			// 
    ...
    "ators. (Only applicable in Icon or Topography mode)";
			...
			// donateMenuItem
			// 
			this.donateMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.donatePatreonMenuItem,
            this.donatePayPalMenuItem});
			...
			// joinDiscordMenuItem
			// 
			this.joinDiscordMenuItem.Name = "joinDiscordMenuItem";
			this.joinDiscordMenuItem.Size = new System.Drawing.Size(103, 20);
			this.joinDiscordMenuItem.Text = "Join the Discord";
			this.joinDiscordMenuItem.ToolTipText = "Join the Mappalachia Discord.";
			this.joinDiscordMenuItem.Click += new System.EventHandler(this.JoinDiscord);
			// 
