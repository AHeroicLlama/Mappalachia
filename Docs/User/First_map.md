...
If you are happy with the items, press the 'Update Map' button. Mappalachia will then collect the coordinates for every instance of your selected items and plot them with icons on the map. When finished the map preview window will update with your plots, and will display a legend on the right hand side of the image, along with the icons which they are represented by.<br/>
