...
* The Door Marker can be found at `C:\Program Files (x86)\Steam\steamapps\common\Fallout76\Data\SeventySix - Interface.ba2\interface\mapmarkerlibrary.swf\sprites\DefineSprite (442)`
* The Infestation Marker can be found at `C:\Program Files (x86)\Steam\steamapps\common\Fallout76\Data\SeventySix - Interface.ba2\interface\recentactivity.swf\sprites\DefineSprite (56)`
